...
$thisfilename = 'dase-library-category.php';
$pagedir = 'library_category';
...
if( $hidop == 'list'){
    ...
    $sqlgetcount = 'select * from '._TABLE_LIBRARY_CATEGORY;
    ...
    $sql_table = _TABLE_LIBRARY_CATEGORY;
    ...
    $sql = 'select * from '._TABLE_LIBRARY_CATEGORY.' where id='.$id;
    $result = mysql_query($sql);
    include('pages/check-db-result.php');   
    $row  = array();
    ...
    $sql = 'delete from '._TABLE_LIBRARY_CATEGORY.' where id='.$id.' limit 1';
    $result = mysql_query($sql);
    include('pages/check-db-result.php');
