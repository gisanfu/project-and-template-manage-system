...
$thisfilename = 'dase-library-subdir.php';
$pagedir = 'library_subdir';
...
if( $hidop == 'list'){
    ...
    $sqlgetcount = 'select * from '._TABLE_LIBRARY_SUBDIR;
    ...
    $sql_table = _TABLE_LIBRARY_SUBDIR;
    ...
    $sql = 'select * from '._TABLE_LIBRARY_SUBDIR.' where id='.$id;
    $result = mysql_query($sql);
    include('pages/check-db-result.php');   
    $row  = array();
    $row = mysql_fetch_array($result,MYSQL_ASSOC);
    include('pages/debug-db-result.php');
    $smarty->assign("subdir",$row);
    ...
    $sql = 'delete from '._TABLE_LIBRARY_SUBDIR.' where id='.$id.' limit 1';
    $result = mysql_query($sql);
    include('pages/check-db-result.php');
