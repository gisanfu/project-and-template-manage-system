...
$thisfilename = 'dase-block-example.php';
$pagedir = 'block_example';
...
if( $hidop == 'list'){
    ...
    $sqlgetcount = 'select * from '._TABLE_BLOCK_EXAMPLE;
    ...
    $sql_table = _TABLE_BLOCK_EXAMPLE;
    ...
    $sql = 'select * from '._TABLE_BLOCK_EXAMPLE.' where id='.$id;
    $result = mysql_query($sql);
    include('pages/check-db-result.php');   
    $row  = array();
    ...
    $sql = 'delete from '._TABLE_BLOCK_EXAMPLE.' where id='.$id.' limit 1';
    $result = mysql_query($sql);
    include('pages/check-db-result.php');
