...
$thisfilename = 'dase-controller-example.php';
$pagedir = 'controller_example';
...
if( $hidop == 'list'){
    ...
    $sqlgetcount = 'select * from '._TABLE_CONTROLLER_EXAMPLE;
    ...
    $sql_table = _TABLE_CONTROLLER_EXAMPLE;
    ...
    // 取得要修改的controller資料
    $sql = 'select * from '._TABLE_CONTROLLER_EXAMPLE.' where id='.$id;
    $result = mysql_query($sql);
    include('pages/check-db-result.php');   
    $row  = array();
    ...
    $sql = 'delete from '._TABLE_CONTROLLER_EXAMPLE.' where id='.$id.' limit 1';
    $result = mysql_query($sql);
    include('pages/check-db-result.php');
