...
$thisfilename = 'dase-package-company.php';
$pagedir = 'package_company';
...
if( $hidop == 'list'){
    ...
    $sqlgetcount = 'select * from '._TABLE_PACKAGE_COMPANY;  
    ...
    $sql = 'select * from '._TABLE_PACKAGE_COMPANY.' where id='.$id;
    $result = mysql_query($sql);
    include('pages/check-db-result.php');   
    $row  = array();
    $row = mysql_fetch_array($result,MYSQL_ASSOC);
    include('pages/debug-db-result.php');
    $smarty->assign("packagecompany",$row);
    ...
    $sql = 'delete from '._TABLE_PACKAGE_COMPANY.' where id='.$id.' limit 1';
    $result = mysql_query($sql);
    include('pages/check-db-result.php');
