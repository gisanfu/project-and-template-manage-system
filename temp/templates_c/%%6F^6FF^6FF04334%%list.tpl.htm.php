<?php /* Smarty version 2.6.22, created on 2009-02-09 15:01:58
         compiled from install_script/list.tpl.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'install_script/list.tpl.htm', 27, false),)), $this); ?>
...
<?php 
  ...
  $this->_tpl_vars['rows'] = $this->_tpl_vars['installscripts'];
 ?>
...
?>
    <tr>
      <td><?php echo ((is_array($_tmp=@$this->_tpl_vars['rows'][$this->_sections['num01']['index']]['description'])) ? $this->_run_mod_handler('default', true, $_tmp, "&nbsp;") : smarty_modifier_default($_tmp, "&nbsp;")); ?>
</td>
      <td>
        <?php echo ((is_array($_tmp=@$this->_tpl_vars['rows'][$this->_sections['num01']['index']]['path'])) ? $this->_run_mod_handler('default', true, $_tmp, "&nbsp;") : smarty_modifier_default($_tmp, "&nbsp;")); ?>

      </td>
      <td>
        <a href="<?php echo $this->_tpl_vars['targetpost']; ?>
?hidop=exportinstallscript&id=<?php echo $this->_tpl_vars['rows'][$this->_sections['num01']['index']]['id']; ?>
">[產生]</a>
      </td>
      <td>
        <div align="center">
