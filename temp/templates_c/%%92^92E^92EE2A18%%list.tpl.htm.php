<?php /* Smarty version 2.6.22, created on 2009-02-08 22:10:52
         compiled from package_company/list.tpl.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'package_company/list.tpl.htm', 27, false),)), $this); ?>
...
<?php 
  ...
  $this->_tpl_vars['rows'] = $this->_tpl_vars['packagecompanys'];
 ?>
...
?>
    <tr>
      ...
      <td>
        <?php echo ((is_array($_tmp=@$this->_tpl_vars['rows'][$this->_sections['num01']['index']]['homepage'])) ? $this->_run_mod_handler('default', true, $_tmp, "&nbsp;") : smarty_modifier_default($_tmp, "&nbsp;")); ?>

      </td>
      <td>
        <div align="center">
          <a href="dase-package.php?hidop=list&package_company_id=<?php echo $this->_tpl_vars['rows'][$this->_sections['num01']['index']]['id']; ?>
">
            套件
          </a>
        </div>
