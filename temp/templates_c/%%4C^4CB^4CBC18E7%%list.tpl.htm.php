<?php /* Smarty version 2.6.22, created on 2009-02-11 14:24:47
         compiled from controller/list.tpl.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'controller/list.tpl.htm', 37, false),)), $this); ?>
所在位置:
/<a href="dase-project.php?hidop=funclist&id=<?php echo $this->_tpl_vars['project_id']; ?>
"><?php echo $this->_tpl_vars['cg_name']; ?>
</a>/Controller區塊管理<br><br>
...
<a href="<?php echo $this->_tpl_vars['targetpost']; ?>
?hidop=exportcontrollers&project_id=<?php echo $this->_tpl_vars['project_id']; ?>
" style="text-decoration:none;color:#0052D9;">
  [export]
  匯出所有Controller區塊 
</a>
...
<?php $this->_tpl_vars['rows'] = $this->_tpl_vars['controllers']; ?>
...
<?php else: ?>
  ...
  <tr>
    <td class="hed">Controller區塊名稱</td>
    <td class="hed">描述</td>
    <td class="hed">匯出本區塊</td>
...
?>
    <tr>
      ...
      <td>
        <div align="center">
          <a href="<?php echo $this->_tpl_vars['targetpost']; ?>
?hidop=exportcontroller&id=<?php echo $this->_tpl_vars['rows'][$this->_sections['num01']['index']]['id']; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'normal/framework_description.tpl.htm', 'smarty_include_vars' => array()));
